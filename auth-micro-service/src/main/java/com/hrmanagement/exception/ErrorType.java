...
public enum ErrorType {
    ...
    USER_NOT_FOUND(4003,"Böyle bir Kullanıcı Bulunamadı",HttpStatus.BAD_REQUEST),
    ...
    USER_ACCESS_ERROR(4008, "Kullanıcı, yönetici tarafından engellenmiştir.", HttpStatus.BAD_REQUEST),
